...
export default function EditListing() {
  ...
  async function onSubmit(event){
    ...
    setLoading(true);
    // sometimes while getting numbers from, it considers them as a string.To ensure that it does not consider -
    // it as string we add + operator in front of it to change it to integer. 
    ...
    //The below code is for geolocation, you can also use longitude and latitude options given in the form instead of this 
    let geolocation = {}
    let location 
          ...
          {!geolocationEnabled && (
            <div className='flex space-x-6 justify-start mb-6'>
              <div>
                ...
                value={latitude} onChange={onChange}
                required
                min="-90"
                max="90"
                className='w-full px-4 py-2 text-xl text-gray-700 
              ...
              <div>
                ...
                value={longitude} onChange={onChange}
                required
                min="-180"
                max="180"
                className='w-full px-4 py-2 text-xl text-gray-700 
          ...
          <div className='flex items-center mb-6'>
            <div>
              ...
              space-x-6'>
                ...
                onChange={onChange} 
                minLength="50" maxLength="400000000" required
                className='w-full px-4 py-2 text-xl text-gray-700
          ...
          {offer && (
            ...
            <div>
              ...
              space-x-6'>
                ...
                onChange={onChange} 
                minLength="50" maxLength="400000000" required={offer}
                className='w-full px-4 py-2 text-xl text-gray-700
                bg-white border border-gray-300 rounded
                transition duration-150 ease-in-out focus:text-gray-700
                focus:bg-white focus:border-slate-600 text-center'/>
