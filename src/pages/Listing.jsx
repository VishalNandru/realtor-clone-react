...
export default function Listing() {
  ...
  return (
    <main>
        ...
        {shareLinkCopied && (<p className='fixed top-[23%] right-[5%] z-10
        font-semibold border-2 border-gray-400 rounded-md bg-white p-2'>Link copied</p>)}
            ...
            <div className=' w-full'>
                ...
                <div className='flex justify-start items-center space-x-4 w-[75%]'>
                    ...
                    {listing.offer && (
                        ...
                        >${+listing.regularPrice - +listing.discountPrice} discount</p> //the "+"" here converts string into integer, since the regular and discount prices are stored as string in the database we converted them to integer
                    )}
                </div>
                ...
                {listing.userRef !== auth.currentUser?.uid && !contactLandlord && (
                    ...
                    w-full text-center transition duration-150
                    ease-in-out mt-6'>Contact Landlord</button>
                    </div>
                ) }
                {contactLandlord && (
                    <Contact 
