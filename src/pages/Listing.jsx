  ...
  return (
    <main>
      ...
      {shareLinkCopied && (
        ...
        font-semibold border-2 border-gray-400 rounded-md bg-white p-2"
        >
          Link copied
        </p>
      )}
        ...
        <div className=" w-full">
          ...
          <div className="flex justify-start items-center space-x-4 w-[75%]">
            ...
            {listing.offer && (
              ...
              </p> //the "+"" here converts string into integer, since the regular and discount prices are stored as string in the database we converted them to integer
            )}
          </div>
